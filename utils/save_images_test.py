...
def save_images_test(saved_all, epoch, folder, resize_to=None):
...
def get_random_images_test(images, encoded_images, noised_images):
...
def concatenate_images_test(saved_all, images, encoded_images, noised_images):
	saved = get_random_images_test(images, encoded_images, noised_images)
