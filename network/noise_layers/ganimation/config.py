...
def get_config():
    ...
    parser.add_argument('--outputs_dir', type=str, default='temp/')
    ...
    parser.add_argument('--animation_images_dir', type=str,
                        default='network/noise_layers/ganimation/eric_andre/images_to_animate')
    parser.add_argument('--animation_attribute_images_dir', type=str,
                        default='network/noise_layers/ganimation/eric_andre/attribute_images')
    parser.add_argument('--animation_attributes_path', type=str,
                        default='network/noise_layers/ganimation/eric_andre/attributes.txt')
    parser.add_argument('--animation_models_dir', type=str,
                        default='network/noise_layers/ganimation/eric_andre/pretrained_models')
    parser.add_argument('--animation_results_dir', type=str,
                        default='network/noise_layers/ganimation/eric_andre/results')
