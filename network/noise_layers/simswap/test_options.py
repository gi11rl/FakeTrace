...
Description: 
'''
from network.noise_layers.simswap.base_options import BaseOptions
...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("--Arc_path", type=str, default='./network/noise_layers/simswap/arcface_checkpoint.tar', help="run ONNX model via TRT")
