...
from network.noise_layers.simswap.models.base_model import BaseModel
from network.noise_layers.simswap.models import networks
import sys

sys.path.insert(0, './network/noise_layers/simswap/')
...
class fsModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        if opt.crop_size == 224:
            from network.noise_layers.simswap.models.fs_networks import Generator_Adain_Upsample, Discriminator
        elif opt.crop_size == 512:
            from network.noise_layers.simswap.models.fs_networks_512 import Generator_Adain_Upsample, Discriminator
